<x-app-layout>
    ...
    <div class="py-12">
        <form action="{{ route('kartu-keluarga.update', $kartu_keluarga->id_keluarga) }}" method="POST">
                ...
                <div class=" md:w-5/6 p-6 bg-white dark:bg-gray-800 overflow-hidden shadow-md sm:rounded-lg">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="nomor_keluarga" class="block mt-1 w-full" type="text" name="nomor_keluarga"
                            :value="old('nomor_keluarga', $kartu_keluarga->nomor_keluarga)" />
                        ...
                        <select id="id_kepala_keluarga" name="id_kepala_keluarga"
                            ...
                            @foreach ($data_warga as $warga)
                                <option value="{{ $warga->id_warga }}"
                                    {{ old('id_kepala_keluarga', $kartu_keluarga->id_kepala_keluarga) == $warga->id_warga ? 'selected' : '' }}>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="alamat_keluarga" name="alamat_keluarga"
                            class="block mt-1 w-full h-20 resize-none border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('alamat_keluarga', $kartu_keluarga->alamat_keluarga) }}</textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="desa_kelurahan_keluarga" class="block mt-1 w-full" type="text"
                            name="desa_kelurahan_keluarga" :value="old('desa_kelurahan_keluarga', $kartu_keluarga->desa_kelurahan_keluarga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="kecamatan_keluarga" class="block mt-1 w-full" type="text"
                            name="kecamatan_keluarga" :value="old('kecamatan_keluarga', $kartu_keluarga->kecamatan_keluarga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="kabupaten_kota_keluarga" class="block mt-1 w-full" type="text"
                            name="kabupaten_kota_keluarga" :value="old('kabupaten_kota_keluarga', $kartu_keluarga->kabupaten_kota_keluarga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="provinsi_keluarga" class="block mt-1 w-full" type="text"
                            name="provinsi_keluarga" :value="old('provinsi_keluarga', $kartu_keluarga->provinsi_keluarga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="rt_keluarga" class="block mt-1 w-full" type="text" name="rt_keluarga"
                            :value="old('rt_keluarga', $kartu_keluarga->rt_keluarga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="rw_keluarga" class="block mt-1 w-full" type="text" name="rw_keluarga"
                            :value="old('rw_keluarga', $kartu_keluarga->rw_keluarga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="kode_pos_keluarga" class="block mt-1 w-full" type="text"
                            name="kode_pos_keluarga" :value="old('kode_pos_keluarga', $kartu_keluarga->kode_pos_keluarga)" />
