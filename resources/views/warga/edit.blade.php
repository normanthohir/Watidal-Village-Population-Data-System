        ...
        <form action="{{ route('warga.update', $warga->id_warga) }}" method="POST">
            ...
            <div class=" md:flex max-w-7xl mx-auto sm:px-2 lg:px-8">
                <div class="md:w-5/6 bg-white dark:bg-gray-900 overflow-hidden shadow-sm sm:rounded-lg px-14 pt-8 pb-6 transition-colors duration-300">
                    <h1 class="text-2xl font-bold mb-4 text-black dark:text-putih ">Edit Data Warga</h1>
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="nik_warga" class="block mt-1 w-full" type="text" name="nik_warga"
                            :value="old('nik_warga', $warga->nik_warga)" autofocus />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="nama_warga" class="block mt-1 w-full" type="text" name="nama_warga"
                            :value="old('nama_warga', $warga->nama_warga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="tempat_lahir_warga" class="block mt-1 w-full" type="text"
                            name="tempat_lahir_warga" :value="old('tempat_lahir_warga', $warga->tempat_lahir_warga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="tanggal_lahir_warga" class="block mt-1 w-full" type="date"
                            name="tanggal_lahir_warga" :value="old('tanggal_lahir_warga', $warga->tanggal_lahir_warga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <select id="jenis_kelamin_warga" name="jenis_kelamin_warga"
                            ...
                            <option value="L"
                                {{ old('jenis_kelamin_warga', $warga->jenis_kelamin_warga) == 'L' ? 'selected' : '' }}>
                                Laki-laki</option>
                            <option value="P"
                                {{ old('jenis_kelamin_warga', $warga->jenis_kelamin_warga) == 'P' ? 'selected' : '' }}>
                                Perempuan</option>
                        </select>
                        <x-input-error :messages="$errors->get('jenis_kelamin_warga')" class="mt-2" />
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="alamat_ktp_warga" name="alamat_ktp_warga"
                            class="block mt-1 w-full h-20 resize-none border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('alamat_ktp_warga', $warga->alamat_ktp_warga) }}</textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="alamat_warga" name="alamat_warga"
                            class="block mt-1 w-full h-20 resize-none border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('alamat_warga', $warga->alamat_warga) }}</textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="desa_kelurahan_warga" class="block mt-1 w-full" type="text"
                            name="desa_kelurahan_warga" :value="old('desa_kelurahan_warga', $warga->desa_kelurahan_warga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="kecamatan_warga" class="block mt-1 w-full" type="text"
                            name="kecamatan_warga" :value="old('kecamatan_warga', $warga->kecamatan_warga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="kabupaten_kota_warga" class="block mt-1 w-full" type="text"
                            name="kabupaten_kota_warga" :value="old('kabupaten_kota_warga', $warga->kabupaten_kota_warga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="provinsi_warga" class="block mt-1 w-full" type="text" name="provinsi_warga"
                            :value="old('provinsi_warga', $warga->provinsi_warga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="rt_warga" class="block mt-1 w-full" type="text" name="rt_warga"
                            :value="old('rt_warga', $warga->rt_warga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="rw_warga" class="block mt-1 w-full" type="text" name="rw_warga"
                            :value="old('rw_warga', $warga->rw_warga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="agama_warga" class="block mt-1 w-full" type="text" name="agama_warga"
                            :value="old('agama_warga', $warga->agama_warga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="pendidikan_terakhir_warga" class="block mt-1 w-full" type="text"
                            name="pendidikan_terakhir_warga" :value="old('pendidikan_terakhir_warga', $warga->pendidikan_terakhir_warga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="pekerjaan_warga" class="block mt-1 w-full" type="text"
                            name="pekerjaan_warga" :value="old('pekerjaan_warga', $warga->pekerjaan_warga)" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="status_perkawinan_warga" class="block mt-1 w-full" type="text"
                            name="status_perkawinan_warga" :value="old('status_perkawinan_warga', $warga->status_perkawinan_warga)" />
                        <x-input-error :messages="$errors->get('status_perkawinan_warga')" class="mt-2" />
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="status_warga" class="block mt-1 w-full" type="text" name="status_warga"
                            :value="old('status_warga', $warga->status_warga)" />
                    ...
                    {{-- <div class="mt-4">
                        ...
                        <select id="status_warga" name="status_warga"
                            class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                            <option value="Hidup"
                                {{ old('status_warga', $warga->status_warga) == 'Hidup' ? 'selected' : '' }}>Hidup
                            </option>
                ...
                <div class="md:w-2/6">
                    <div class="md:mt-5 mt-2  md:ml-0 flex items-center justify-center">
                        <button type="submit"
                            class="text-white bg-gradient-to-r shadow-lg hover:bg-gradient-to-br shadow-orens/50 bg-orens hover:bg-orens/80 focus:ring-4 focus:outline-none focus:ring-orens/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:text-gray-900 dark:bg-hijau dark:shadow-hijau/50 dark:hover:bg-hijau/80 dark:focus:ring-hijau/40 me-2 mb-2 ">Perbaharui</button>
